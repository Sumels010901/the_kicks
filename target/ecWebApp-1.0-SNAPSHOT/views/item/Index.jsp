    ...
    <jsp:body>
        <div class="card">
            <h4 class="card-header d-flex justify-content-between">
                Items (Admin)
                <a class="btn btn-outline-success" href="${pageContext.request.contextPath}/Admin/Item/Add" role="button">
                        ...
                        <table class="table table-hover">
                            ...
                            <c:forEach items="${items}" var="c">
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a class="btn btn-sm btn-outline-primary" href="${pageContext.request.contextPath}/Admin/Item/Edit?id=${c.itemID}" role="button">
