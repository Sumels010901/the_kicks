                            ...
                            <c:forEach items="${items}" var="c">
                                <div class="col-sm-4 mb-3">
                                    <div class="card h-100">
                                        <img src="${pageContext.request.contextPath}/public/img/sanpham/${c.itemID}/main_thumbs.jpg" alt="${c.itemName}" title="${c.itemName}" class="card-img-top">
                                        <div class="card-body">
                                        ...
                                        <div class="card-footer text-muted">
                                            <a class="btn btn-sm btn-outline-primary" href="${pageContext.request.contextPath}/item/Detail?id=${c.itemID}" role="button">
